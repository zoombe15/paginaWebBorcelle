...
<body>
    ...
    <section class="product"> 
        <h1 class="product-title">PRODUCTOS</h2>
        <div class="cards-header">
                <h2 class="product-category">Pastillas</h2>         
        </div>
        <div class="cards-body">
                <button class="pre-btn"><img src="ImagenProductos/arrow.png" alt=""></button>       
                <button class="nxt-btn"><img src="ImagenProductos/arrow.png" alt=""></button>
